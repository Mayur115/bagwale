      ...
      .then((res) => {
        ...
        setPaypalStatus(
          !!(
            ...
            res.data.paypalPaymentInfo.status === "1"
          )
        );
        setPayStackStatus(
          !!(
            ...
            res.data.paystackAndMollie.paystack_status === "1"
          )
        );
        setInstaMojoStatus(
          !!(
        ...
        setMollieStatus(
          !!(
            res.data &&
            res.data.paystackAndMollie &&
            res.data.paystackAndMollie.mollie_status === "1"
          )
        );
        setFlutterWaveStatus(
          !!(
            ...
            res.data.flutterwavePaymentInfo.status === "1"
          )
        );
        setRezorPay(
          !!(
            ...
            res.data.razorpayPaymentInfo.status === "1"
          )
        );
        setStripeStatus(
          !!(
            ...
            res.data.stripePaymentInfo.status === "1"
          )
        );
        setCashOnDeliveryStatus(
          !!(
            ...
            res.data.bankPaymentInfo.cash_on_delivery_status === "1"
          )
        );
        setBankPaymentStatus(
          !!(
            res.data &&
            res.data.bankPaymentInfo &&
            res.data.bankPaymentInfo.status === "1"
          )
        );
        setBankInfo(
