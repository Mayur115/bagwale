        ...
        <div className="products-page-wrapper w-full bg-white pt-[30px]">
          <div className="container-x mx-auto">
            {sellerInfo && (
              ...
              >
                {/*<div className="store-status w-[230px] h-[60px] bg-qgreen flex justify-end items-center rounded-full absolute top-[30px] -left-[30px]">*/}
                ...
                <div className="saller-name lg:block hidden">
                  ...
                  <div className="flex justify-center">
                    ...
                    {/*  <div className="flex">*/}
                    {/*    <div className="flex">*/}
                    {/*      {Array.from(Array(sellerInfo.review), () => (*/}
                    {/*        <span key={sellerInfo.review + Math.random()}>*/}
                    {/*          <Star w="30" h="30" />*/}
                    {/*        </span>*/}
                    {/*      ))}*/}
                    {/*    </div>*/}
            ...
            <div className="w-full xl:flex xl:space-x-[30px]">
                    ...
                    <div className="flex flex-col justify-between w-full h-full">
                      <div>
                        ...
                        <div className="mb-[30px]">
                          <h1 className="w-[162px] text-[24px] leading-[30px] text-white font-semibold">
              ...
              <div className="flex-1">
                ...
                >
                  <div>
                    <p className="font-400 text-[13px] text-qgray">
                      <span className="">
                        {" "}
                      ...
                      {langCntnt && langCntnt.of} {response.data.products.total}{" "}
                ...
                {nxtPage && nxtPage !== "null" && (
                  <div className="flex justify-center">
                    <button
                      ...
                      type="button"
                      className="w-[180px] h-[54px] bg-qgreen rounded mt-10"
                    >
