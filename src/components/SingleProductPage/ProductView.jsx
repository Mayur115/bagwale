        ...
        <div className="flex-1">
          <div className="product-details w-full mt-10 lg:mt-0">
            ...
            <div className="p-3 bg-qgreenlow flex items-center space-x-2 mb-[30px] rounded-lg w-fit">
              ...
              <span className="text-base font-bold text-qgreen">
                {product.qty !== "0"
                  ? `${product.qty} ${
            ...
            >
              ...
              <div className="flex-1 h-full">
                <button
                  onClick={addToCard}
                  type="button"
                  className="bg-qgreen text-white rounded-md text-sm font-semibold w-full h-full"
                >
            ...
            <div data-aos="fade-up" className="mb-[20px]">
              <p className="text-[13px] text-qgreen leading-7">
