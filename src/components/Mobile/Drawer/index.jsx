            ...
            <div className="flex justify-between items-center">
              <div className="flex space-x-5 items-center">
                <div className="compaire relative">
                  ...
                  <span className="w-[18px] h-[18px] rounded-full bg-qgreen text-white absolute -top-2.5 -right-2.5 flex justify-center items-center text-[9px]">
          ...
          <div className="w-full mt-5 px-5">
            <div className="search-bar w-full h-[34px]  flex ">
              ...
              <div
                ...
                className="cursor-pointer w-[40px] h-full bg-qgreen flex justify-center items-center"
              >
                    ...
                    <li className="category-item">
                      <Link href="/terms-condition">
                        <div className=" flex justify-between items-center px-5 h-12 bg-white hover:bg-qgreen transition-all duration-300 ease-in-out cursor-pointer">
                          <div className="flex items-center space-x-6">
                            <span className="text-sm font-400 capitalize ">
                              {langCntnt && langCntnt.Term_and_Conditions}
                            </span>
                          </div>
                          <div>
                            <span>
