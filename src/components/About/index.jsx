                    ...
                    <div className="w-[286px] mb-10">
                      <div className="flex justify-center">
                        <div className="flex flex-col items-center">
                          <div className="w-[104px] h-[104px] rounded-full bg-qgreen flex justify-center items-center mb-7">
                            <span>
                              <FontAwesomeCom
              ...
              <div className="content lg:w-1/2 w-full">
                ...
                <Link href="/contact" passHref>
                  <a rel="noopener noreferrer">
                    <div className="w-[160px] h-[54px] mt-10 cursor-pointer rounded bg-qgreen flex justify-center items-center">
            ...
            <div className="slider-btns flex justify-center mt-[40px]">
              <div className="flex space-x-5 item-center">
                <button
                  onClick={prev}
                  type="button"
                  className="w-[48px] h-[48px] rounded-full overflow-hidden flex justify-center items-center border border-qgreen text-qgreen focus:bg-qgreen focus:text-white"
                >
                  <svg
