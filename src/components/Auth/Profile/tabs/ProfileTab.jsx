        ...
        <>
                ...
                <div className="flex xl:justify-center justify-start">
                  <div className="relative">
                    ...
                    <div
                      ...
                      className="w-[32px] h-[32px] absolute bottom-7 sm:right-0 right-[105px]  bg-qgreen rounded-full cursor-pointer"
                    >
                      <svg
                        width="32"
                        height="32"
          ...
          <div className="action-area flex space-x-4 items-center">
            ...
            <button
              ...
              type="button"
              className="w-[164px] h-[50px] bg-qgreen rounded text-white text-sm"
            >
              {langCntnt && langCntnt.Update_Profile}
            </button>
          </div>
